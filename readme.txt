...
3. From MAMP application : click  preferences Tab - point webserver to where the unzipped folder is from step 1.
4. Once MAMP server is started, please hit URL: http://localhost/#/

**** On Tomcat **** 
1. please install Apache Tomcat 8.0. You can try this video: https://www.youtube.com/watch?v=gE1RAEYzgSw. 
2. Please click on "Download ZIP" while on the page: https://github.com/gauriladdad/searchapp
3. Unzip this and put it under - <Your location of tomat>/webapps folder.
